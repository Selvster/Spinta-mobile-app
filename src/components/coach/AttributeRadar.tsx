...
const AttributeRadar: React.FC<AttributeRadarProps> = ({
  ...
  const labelOffset = size * 0.48; // Distance for labels from center
    ...
    <View style={styles.container}>
      <View style={[styles.svgContainer, { width: size, height: size }]}>
        ...
        {attributes.map((attr, index) => {
          ...
          // Calculate if label should be on left or right based on angle
          const angle = (index * (2 * Math.PI)) / attributes.length - Math.PI / 2;
            ...
            <View
              ...
              style={[
                styles.attributeLabel,
                {
                  ...
                  top: pos.y,
                  transform: [
                    { translateX: isLeft ? -60 : isRight ? -20 : -40 },
                    { translateY: isTop ? -35 : isBottom ? -5 : -20 },
                  ],
                },
              ]}
            >
